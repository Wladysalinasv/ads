...
lib.ssMetadata = [
		{name:"300x600_ani_atlas_1", frames: [[435,602,158,159],[0,602,433,194],[0,0,671,600]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["300x600_ani_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.fondo, new cjs.Rectangle(-336,-300,671,600), null);
...
// stage content:
(lib._300x600ani = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(139).call(this.frame_139).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(157));

	// btn
	this.instance = new lib.btn();
	this.instance.setTransform(150,548.75);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(75).to({_off:false},0).to({alpha:1},5).wait(62).to({alpha:0},5).to({_off:true},1).wait(9));

	// text2b
	this.instance_1 = new lib.text2b();
	this.instance_1.setTransform(450.05,520.55,0.4161,0.4161,0,0,0,0.1,0.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(70).to({_off:false},0).to({x:150.05},5).wait(67).to({alpha:0},5).to({_off:true},1).wait(9));

	// text2a
	this.instance_2 = new lib.text2a();
	this.instance_2.setTransform(-162.95,505.9,0.4161,0.4161,0,0,0,0.1,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(70).to({_off:false},0).to({x:152.65},5).wait(67).to({alpha:0},5).to({_off:true},1).wait(9));

	// texto1
	this.instance_3 = new lib.texto1();
	this.instance_3.setTransform(150,148.65,0.0948,0.0948);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(54).to({_off:false},0).to({scaleX:0.3724,scaleY:0.3724},5).to({scaleX:0.2682,scaleY:0.2682},3).wait(80).to({x:-57.6},5).to({_off:true},1).wait(9));

	// titulo1
	this.instance_4 = new lib.titulo1();
	this.instance_4.setTransform(-142.95,196.3,0.295,0.295,0,0,0,0.1,0.4);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(49).to({_off:false},0).to({x:150.05},5).wait(88).to({x:516.05},5).to({_off:true},1).wait(9));

	// titulo2
	this.instance_5 = new lib.titulo2();
	this.instance_5.setTransform(-142.9,234.3,0.295,0.295,0,0,0,0.4,0.4);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(52).to({_off:false},0).to({x:150.1},5).wait(85).to({x:516.1},5).to({_off:true},1).wait(9));

	// logo
	this.instance_6 = new lib.logonegro();
	this.instance_6.setTransform(150,300.05,0.5499,0.5499,0,0,0,0,0.1);
	this.instance_6.alpha = 0;

	this.instance_7 = new lib.logo();
	this.instance_7.setTransform(150,42.15,0.4835,0.4835);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regY:0,scaleX:1,scaleY:1,y:300,alpha:1},9).wait(35).to({regY:0.1,scaleX:0.5664,scaleY:0.5664,y:53.8},5).to({_off:true},93).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(142).to({_off:false},0).wait(5).to({_off:true},1).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(70).to({_off:false},0).to({y:551.4,alpha:1},5).to({_off:true},73).wait(9));

	// fondo
	this.instance_9 = new lib.fondo();
	this.instance_9.setTransform(-34.6,300.3,1.032,1.032,0,0,0,0.1,0.3);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(44).to({_off:false},0).to({alpha:1},9).wait(95).to({alpha:0},7).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-231.4,290.4,876.9,552.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_ani_atlas_1.png?1778507755121", id:"300x600_ani_atlas_1"}
	],
	preloads: []
};
