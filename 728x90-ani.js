...
lib.ssMetadata = [
		{name:"728x90_ani_atlas_1", frames: [[435,0,158,159],[0,0,433,194],[0,196,728,90]]}
];
...
(lib.CachedBmp_8 = function() {
	this.initialize(ss["728x90_ani_atlas_1"]);
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_ani_atlas_1.png?1778507791344", id:"728x90_ani_atlas_1"}
	],
	preloads: []
};
